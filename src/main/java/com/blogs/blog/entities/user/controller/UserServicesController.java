...
import com.blogs.blog.entities.user.services.LoadAuthenticatedUserService;
...
public class UserServicesController {
	...
	public ResponseEntity<User> loadAuthenticatedUser(@AuthenticationPrincipal UserDetails user){
		return loadAuthenticatedUserService.execute(user);
	}
	...
	@RequestBody UserLogInContainer container) {
